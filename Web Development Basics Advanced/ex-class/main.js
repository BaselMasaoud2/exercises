...
},
{
    ...
    const spouses = people.filter(person => person.family && person.family.spouse);
    const totalAgeOfSpouses = spouses.reduce((total, spouse) => total + spouse.family.spouse.age, 0);
    const averageAgeOfSpouses = totalAgeOfSpouses / spouses.length;
    console.log(`Average age of spouses: ${averageAgeOfSpouses}`);
...
for (let i = 0; i < people.length; i++) {
  ...
  if (person.family.spouse !== null) {
    total_age += person.family.spouse.age;
    spouse_Count++;
  }
}

console.log("Average age of all spouses:", total_age / spouse_Count);
